...
import { ConversationListStyle } from '@components/conversation/ConversationList/ConversationList.style';
import {
    ConversationDataProps,
    ConversationListProps
} from '@components/conversation/ConversationList/ConversationList.props';
...
export const ConversationList = ({
    ...
    const [data, setData] = useState<Array<ConversationDataProps>>([]);
    ...
    return (
        <>
            <VirtualizedList
                ...
                contentContainerStyle={ConversationListStyle.contentContainer}
            />
            <View style={ConversationListStyle.bottomContainer}>
                <View style={ConversationListStyle.inputContainer}>
                    <View style={[ConversationListStyle.iconsButtonsView]}>
                        <IconButton
                            icon={IconEnum.PHOTO}
                            onPress={openPhoto}
                            size={24}
                            style={[
                                ConversationListStyle.photoIcon,
                                ConversationListStyle.iconButton
                            ]}
                        />
                        <IconButton
                            ...
                            onPress={openGallery}
                            size={20}
                            style={ConversationListStyle.iconButton}
                        />
                    </View>
                    <TextInput
                        placeholder="Message..."
                        ...
                        style={ConversationListStyle.input}
                    />
                    <View style={ConversationListStyle.sendView}>
                        <TouchableOpacity
                            disabled={!messageValue}
                            onPress={onSend}
                        >
                            <Text style={ConversationListStyle.send}>Send</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
